...
class Email {
    ...
    function confirmationEmail($email, $key) 
    {
        ...
        $body = file_get_contents(dirname(dirname(__FILE__)) . '/temp/confirmation-mail.php');
    ...
    function passwordResetEmail($email, $key) 
    {
        ...
        $body = file_get_contents(dirname(dirname(__FILE__)) . '/temp/forgot-password-mail.php');
